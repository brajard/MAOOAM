...
123                    ol=l
124 
125                    \textcolor{keyword}{CALL }integrate(func\_ijkl,ss)
126                    \textcolor{keywordflow}{IF} (abs(ss)>real\_eps) n=n+1
127 \textcolor{keywordflow}{                ENDDO}
128 \textcolor{keywordflow}{             ENDDO}
129 \textcolor{keywordflow}{          ENDDO}
130           \textcolor{keywordflow}{IF} (n/=0) \textcolor{keywordflow}{THEN}
131              \textcolor{keyword}{ALLOCATE}(corr2int(ind(i))%elems(n), \hyperlink{namespacestat}{stat}=allocstat)
132              \textcolor{keywordflow}{IF} (allocstat /= 0) stop \textcolor{stringliteral}{"*** Not enough memory ! ***"}
133 
134              n=0
135              \textcolor{keywordflow}{DO} j= 1,n\_unres
136                 \textcolor{keywordflow}{DO} k= 1,n\_unres
137                    \textcolor{keywordflow}{DO} l = 1,n\_unres
138                       oi=i
139                       oj=j
140                       ok=k
141                       ol=l
142 
143                       \textcolor{keyword}{CALL }integrate(func\_ijkl,ss)
144                       \textcolor{keywordflow}{IF} (abs(ss)>real\_eps) \textcolor{keywordflow}{THEN}
145                          n=n+1
...
157 
158        \textcolor{keyword}{CALL }write\_tensor4\_to\_file(\textcolor{stringliteral}{"corr2int.def"},corr2int)
159 \textcolor{keywordflow}{    CASE DEFAULT}
160        stop \textcolor{stringliteral}{'*** INT\_CORR\_MODE variable not properly defined in corrmod.nml ***'}
